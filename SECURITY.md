...
Only the latest version of Dispatch will recieve security updates.
These will be released as new versions of the module. 

## Reporting a Vulnerability

You can report a vulnerability by [opening an Issue]([url](https://github.com/misterpotts/dispatch/issues/new?assignees=&labels=triage&projects=&template=vulnerability-report.md&title=Vulnerability%3A+)https://github.com/misterpotts/dispatch/issues/new?assignees=&labels=triage&projects=&template=vulnerability-report.md&title=Vulnerability%3A+).
