...
Any contributions you make will be reflected in this repository's [contributor insights](https://github.com/misterpotts/dispatch/graphs/contributors).
...
To navigate the codebase with confidence, see [the introduction to working on Dispatch](#introduction-to-working-on-dispatch) :confetti_ball:.
...
### Introduction to working on Dispatch

Check out the section on [building Dispatch](README.md#building-dispatch) in [README.md](README.md).
...
If you'd like help troubleshooting a PR you're working on, have a great new idea, or want to share something amazing you've learned, you can join or start a [discussion](https://github.com/misterpotts/dispatch/discussions).

### :lady_beetle: Issues

[Issues](https://github.com/misterpotts/dispatch/issues) are used to track tasks that contributors can help with. 
...
If it's something new, open an issue using a [template](https://github.com/misterpotts/dispatch/issues/new/choose). 
The issue will be used to have a conversation about the problem you want to fix.

### :hammer_and_wrench: Pull requests

A [pull request](https://github.com/misterpotts/dispatch/pulls) is a way to propose changes to Dispatch.
...
I am currently working on Dispatch alone.
...
If you have questions about the module and its usage, please join my [Discord](https://discord.gg/P5KVvSNKUZ) and ask in the [#dispatch](https://discord.gg/P5KVvSNKUZ) channel.
...
Dispatch is currently only available in **English**.
...
If you spot a problem or see an opportunity for a new feature, [search to see if an issue already exists](https://github.com/misterpotts/dispatch/issues). 
If a related issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/misterpotts/dispatch/issues/new/choose).

#### Solve an issue

Scan through the [existing issues](https://github.com/misterpotts/dispatch/issues) to find one that interests you. 
...
Dispatch uses [Conventional Commits](https://www.conventionalcommits.org/) for commit messages.
...
Once your PR is merged, your contributions will be publicly visible on the [contributor insights](https://github.com/misterpotts/dispatch/graphs/contributors).

Now that you are part of the Dispatch developer community, see how else you can [contribute](#contributing-to-dispatch).

## Principles

Dispatch is built to a set of technical principles that guide the development of the module.
...
Dispatch is built to be easy to use, as well as change.
...
Dispatch aims to solve problems in a manner that is consistent across the codebase and familiar to developers from other projects and backgrounds.
...
Dispatch uses composition over inheritance to solve problems.
...
To this end, Dispatch uses [dependency inversion](https://en.wikipedia.org/wiki/Dependency_inversion_principle) to compose types.
This means that types depend on abstractions (interfaces), rather than concrete implementations.

### Prefer stubs to mocks

Dispatch uses [stubs](https://en.wikipedia.org/wiki/Test_stub) over [mocks](https://en.wikipedia.org/wiki/Mock_object) to test behaviour.
...
Dispatch uses [streams](https://en.wikipedia.org/wiki/Stream_processing) to perform operations on collections of data.
...
Dispatch also uses [dynamic programming](https://en.wikipedia.org/wiki/Dynamic_programming) techniques over [recursion](https://en.wikipedia.org/wiki/Recursion_(computer_science)).
